...
<body>
	...
	<h4>Shop</h4>
	<a href="/ch10/shop/customer/list.do">Customer CRUD</a> <!-- 완 -->
	<a href="/ch10/shop/product/list.do">Product CRUD</a> <!-- 완 -->
	
	<h4>College</h4>
	<a href="/ch10/college/student/list.do">Student CRUD</a> <!-- 완 -->
