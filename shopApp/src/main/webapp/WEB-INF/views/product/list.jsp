...
<body>
	...
	<c:if test="${not empty sessUser}">
	    <p>${sessUser.name}(${sessUser.custId})님, 환영합니다!</p>
	...
	<table border="1">
		...
		<form action ="/shopApp/order/register.do" method="GET">
			<tr>
				...
				<td>
					<a href="/shopApp/product/modify.do?prodNo=${product.prodNo}">수정</a>
					<a href="/shopApp/product/delete.do?prodNo=${product.prodNo}">삭제</a>
				</td>
			</tr>
			</form>
		</c:forEach>
